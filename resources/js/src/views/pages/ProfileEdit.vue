...
<template>
  <div id="page-user-edit">
    ...
    <vs-alert color="danger" title="Limited Access" :active.sync="user_not_found">
      <span>Access Denied.</span>
      <span>
        <span>Check </span><router-link :to="{name: 'page-profile-edit', params: { userId: 'adoptionism744' }}" class="text-inherit underline">Your Profile</router-link>
      </span>
    </vs-alert>
