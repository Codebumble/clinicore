	...
	<div class="vx-col w-full mb-base">
		<vx-card title="Admit a Patient for Your Hospital">
			<div class="vx-row">
				...
				<div class="vx-col sm:w-1/2 w-full mb-2">
					<vs-input class="w-full" icon-pack="feather" icon="icon-plus" label-placeholder="Full Name*"
						v-model="fname" />
				</div>
				<div class="vx-col sm:w-1/2 w-full mb-2">
					<vs-input class="w-full" icon-pack="feather" icon="icon-edit" label-placeholder="Address"
						v-model="addr" />
				</div>
				<div class="vx-col sm:w-1/2 w-full mb-2">
			...
			<div class="vx-row">
				<div class="vx-col w-full mt-5">
					...
					<vs-button color="warning" type="border" class="mb-2"
						@click="fname = patientID = addr = city = post = country = mob = input3 = admitDate = releaseDate = policyNo = agentName = guardianRel = guardianContact = guardianAddr = ''; check7 = false;">
						Reset</vs-button>
				</div>
			</div>
		</vx-card>
