        ...
        <vx-card id="invoice-container">
            ...
            <div class="p-base">
                ...
                <vs-table hoverFlat :data="invoiceData.tasks">
                    <!-- HEADER -->
                    <template slot="thead">
                        <vs-th class="pointer-events-none">Madicine Name</vs-th>
                        <vs-th class="pointer-events-none">Price(Per)</vs-th>
                        <vs-th class="pointer-events-none">Quantity</vs-th>
                        <vs-th class="pointer-events-none">Cost</vs-th>
                    </template>

                    <!-- DATA -->
                    <template slot-scope="{data}">
                        <vs-tr v-for="(tr, index) in data" :key="index">
                            <vs-td :data="data[index].mName">{{ data[index].mName }}</vs-td>
                            <vs-td :data="data[index].price">{{ data[index].price }}</vs-td>
                            <vs-td :data="data[index].quantity">{{ data[index].quantity }} TK</vs-td>
                            <vs-td :data="data[index].cost">{{ data[index].cost }} TK</vs-td>
                        </vs-tr>
                    </template>
                </vs-table>
