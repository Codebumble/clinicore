<template>
	<div class="vx-col w-full mb-base">
		<vx-card title="Add Invoice Data">
			<div class="vx-row">
				<div class="vx-col sm:w-1/2 w-full mb-2">
					<vs-input class="w-full" icon-pack="feather" icon="icon-plus" label-placeholder="Client Name*" v-model="name" />
				</div>
			</div>
            <div class="vx-row">
				<div class="vx-col sm:w-1/2 w-full mb-2">
					<vs-input class="w-full" icon-pack="feather" icon="icon-plus" label-placeholder="Phone Number*" v-model="phone" />
				</div>
			</div>
			<div class="vx-row">
				<div class="vx-col sm:w-1/3 w-full mb-2 mt-3">
					<flat-pickr :placeholder="new Date()" v-model="pdate" :config="{ dateFormat: 'd F Y', maxDate: new Date() }" class="w-full" v-validate="'required'" />
				</div>
			</div>
      ...
      <li>
        <vs-radio class="m-4" v-model="servicePackage.radios2" vs-value="box">Box</vs-radio>
      </li>
      <li>
        <vs-radio class="m-4" color="success" v-model="servicePackage.radios2" vs-value="unit">Unit</vs-radio>
      </li>
                                    </ul>
								</vs-td>
								<vs-td>
			...
			<div class="vx-row">
				<div class="vx-col w-full">
					...
					<vs-popup background-color="rgba(255,255,255,.6)" :background-color-popup="colorx" class=""
						...
						<p> Are You Sure You Want to Add This Invoice Info?</p><br>
