<template>
	<div class="vx-col w-full mb-base">
		<vx-card title="Add Death Report">
			<div class="vx-row">
            ...
            <flat-pickr placeholder="Date of Entry" v-model="date" :config="{ dateFormat: 'd F Y', maxDate: new Date() }" class="w-full" v-validate="'required'" />
          </div>
          </div>
			<div class="vx-row">
				<div class="vx-col sm:w-1/2 w-full mb-2 mt-5">
					<vs-textarea counter="100" label="Additional Information" :counter-danger.sync="counterDanger" v-model="textarea" />
				</div>
			</div>
			...
			<div class="vx-row">
				<div class="vx-col w-full">
					...
					<vs-popup background-color="rgba(255,255,255,.6)" :background-color-popup="colorx" class=""
						...
						<p> Are You Sure You Want to Add The Report?</p><br>
...
export default {
	data() {
      ...
      selected: {id: 1, label: 'Cert. Signed by'},
      options2: [
