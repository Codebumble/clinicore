...
<html lang="en">
  <head>
    ...
    <title>CliniCore Hospital Management System</title>
    <!-- Styles -->
  ...
  <body>
    <noscript>
      <strong>We're sorry but CliniCore doesn't work properly without JavaScript enabled. Please enable it to continue.</strong>
    </noscript>
    <div id="app">
    </div>
